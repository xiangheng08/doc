...
export interface Pager<Item = any, Extra extends Record<string, any> = {}> {
  /**
   * 当前页码
   */
  page_no: number
...
export const usePaging = <Item = any, Extra extends Record<string, any> = {}>({
  page_no = 1,
  page_size = 15,
  fetchFu,
  params = {},
