...
-   [`<image>`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/image) 用来标记将要显示的图片。支持[多背景 (en-US)](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_backgrounds_and_borders/Using_multiple_backgrounds)设置，背景之间以逗号隔开。
